...
public class StudentEditActivity extends AppCompatActivity {
    ...
    private void updateStudentInDataset() {
        ...
        Toast.makeText(getApplicationContext(),"Update Student Successfully!",Toast.LENGTH_SHORT).show();
        finish();
    ...
    private void removeStudent() {
        ...
        Toast.makeText(getApplicationContext(),"Remove Student Successfully!",Toast.LENGTH_SHORT).show();
        finish();
    }
}
