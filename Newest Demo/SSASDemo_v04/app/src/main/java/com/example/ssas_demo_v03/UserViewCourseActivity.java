...
public class UserViewCourseActivity extends AppCompatActivity {
    ...
    private void loadPage() {
        ...
        mButtonToEdit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(UserViewCourseActivity.this,UserEditActivity.class));
            }
        });
    ...
    private void addCourse() {
        ...
        Toast.makeText(getApplicationContext(),"Add New Course Successfully!",Toast.LENGTH_SHORT).show();
