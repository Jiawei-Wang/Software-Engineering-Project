...
public class DataBaseContract {
    ...
    public static final class StudentCourseEntry implements BaseColumns{
        public static final String TABLE_NAME = "StudentCourse";
        public static final String COLUMN_ID = "Choiceid";
        public static final String COLUMN_STUDENT_ID = "Studentid";
        public static final String COLUMN_COUSER_ID = "Courseid";
    }
}
